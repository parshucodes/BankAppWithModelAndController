...
namespace BankAppWithModelAndController;
...
public class CustomerController
{
    ...
    public void Withdraw()
    {
        ...
        if (customer.IsActive)
        {
            ...
            else
            {
                ...
                Console.WriteLine("Please Collect the cash, the available balance: {0}",customer.Balance);
            }
        }
        else
        {
    ...
    private void WriteJsonData(Customer customer)
    {
        ...
        File.WriteAllText(@"C:\Users\parsh\Documents\Projects\bankappwithmodelandcontroller\Account\"+customer.CustomerId+".json", jsonString);
    }

    private Customer ReadJsonData(int customerId)
    {
        var fileData = File.ReadAllText(@"C:\Users\parsh\Documents\Projects\bankappwithmodelandcontroller\Account\"+customerId+".json");
